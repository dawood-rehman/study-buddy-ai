  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-8">
        {quickActions.map((a) => (
          <Link
            key={a.title}
            to={a.to}
            className="glass-card p-4 flex flex-col items-center gap-2 hover:shadow-lg transition-all duration-200 hover:-translate-y-0.5"
          >
      ...
      <div className="glass-card p-10 text-center">
        ...
        <Link to="/study" className="inline-flex items-center gap-2 px-4 py-2 rounded-lg gradient-primary text-primary-foreground font-medium text-sm">
